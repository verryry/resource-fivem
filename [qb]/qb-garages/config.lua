...
Garages = {
    ["citygarage"] = {
        label = "City Parking",
        takeVehicle = vector3(-281.3, -888.1, 31.32),
        spawnPoint = vector4(-289.29, -886.66, 30.57, 167.56),
        putVehicle = vector3(-279.75, -900.91, 31.08),
        showBlip = true,
    ...
    -- ["beachp"] = {
    --     label = "Beach Parking",
    --     takeVehicle = vector3(-1642.44, -869.03, 9.19),
    --     spawnPoint = vector4(-1651.12, -879.0, 8.43, 138.76),
    --     putVehicle = vector3(-1655.22, -884.63, 8.82),
    --     showBlip = true,
    --     blipName = "Public Parking",
    --     blipNumber = 357,
    --     type = 'public',                --public, job, gang, depot
    ...
    ["police"] = {
        label = "Police",
        takeVehicle = vector3(457.55, -1027.08, 28.45),
        spawnPoint = vector4(442.4, -1026.39, 28.2, 3.3),
        putVehicle = vector3(449.52, -1025.9, 28.59),
        showBlip = false,
        blipName = "Police",
        blipNumber = 357,
