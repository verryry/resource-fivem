...
FoodProcessor = {
    ...
    SetBlipSprite = 557,                                -- Blip Icon (https://docs.fivem.net/docs/game-references/blips/)
...
Seller = {
    targetZone = vector3(2310.4, 4885.11, 41.81),
    targetHeading = 315,
    coords = vector4(2310.4, 4885.11, 41.81 - 1.00, 44.23),
    SetBlipSprite = 557,
    SetBlipDisplay = 6,
    SetBlipScale = 0.65,
    SetBlipColour = 2,
