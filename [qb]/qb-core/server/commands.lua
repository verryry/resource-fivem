...
RegisterCommand('police', function(source, args, rawCommand) 
  ...
  RegisterCommand('mech', function(source, args, rawCommand)
    ...
    TriggerClientEvent('chat:addMessage', source, {
      template = '<div style="padding: 0.60vw; margin: 0.05vw; background-color: rgba(205, 0, 0, 0.9); border-radius: 5px;"><i class="fas fa-exclamation"></i>  You need to work in mechanic to use /mech <i class="fas fa-exclamation"></i></div>',
      args = {}
    })
  end
  end, false)
  ...
  RegisterCommand('taxi', function(source, args, rawCommand)
    ...
    TriggerClientEvent('chat:addMessage', source, {
      template = '<div style="padding: 0.60vw; margin: 0.05vw; background-color: rgba(205, 0, 0, 0.9); border-radius: 5px;"><i class="fas fa-exclamation"></i>  You need to work in taxi to use /taxi <i class="fas fa-exclamation"></i></div>',
      args = {}
    })
  end
  end, false)
  ...
  RegisterCommand('rle', function(source, args, rawCommand)
    ...
    TriggerClientEvent('chat:addMessage', source, {
      template = '<div style="padding: 0.60vw; margin: 0.05vw; background-color: rgba(205, 0, 0, 0.9); border-radius: 5px;"><i class="fas fa-exclamation"></i>  You need to work in realestate to use /rle <i class="fas fa-exclamation"></i></div>',
      args = {}
    })
  end
  end, false)
